...
fn linkThisLibrary(b: *std.Build, target: anytype, optimize: std.builtin.Mode) *std.Build.Step.Compile {
...
/// add this package to exe (target: std.Target.Query)
pub fn addTo(b: *std.Build, exe: *std.Build.Step.Compile, target: anytype, optimize: std.builtin.Mode, raylibOptions: raylib_build.Options) void {
