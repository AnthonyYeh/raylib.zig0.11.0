...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/raylib.h:127:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/raylib.h:130:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/raylib.h:133:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/raylib.h:136:13
pub const TRACELOG = @compileError("unable to translate C expr: expected ')' instead got '...'"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/rlgl.h:131:13
pub const TRACELOGD = @compileError("unable to translate C expr: expected ')' instead got '...'"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/rlgl.h:132:13
pub const RMAPI = @compileError("unable to translate C expr: unexpected token 'extern'"); // C:\Users\user\Documents\GitHub\zig0.11.0raylib\raylib.zig\raylib\src/raymath.h:68:17
